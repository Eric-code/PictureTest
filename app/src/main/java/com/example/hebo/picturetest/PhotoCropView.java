...
public class PhotoCropView extends View {
    ...
    private static final int minHeight = 100;/*the minimum height of the rectangle*/
    ...
    public static int sX;/*start X location*/
    public static int sY;/*start Y location*/
    public static int eX;/*end X location*/
    public static int eY;/*end Y location*/
